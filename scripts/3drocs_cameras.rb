...
Orocos::Process.run 'dem_generation', 'control', 'pancam', 'lidar', 'tof', 'bb2', 'bb3', 'imu', 'gps', 'temperature', 'shutter_controller', 'gyro', 'stereo', 'tmtchandling', 'unit_vicon' do
    ...
    if options[:bb2]
        ...
        if options[:bb2egp]
            ...
            Orocos.conf.apply(dem_generation_bb2, ['hdpr_bb2'], :override => true) #TODO FIXME
        elsif options[:bb2exoter]
            ...
            Orocos.conf.apply(dem_generation_bb2, ['exoter_bb2'], :override => true)
        elsif options[:bb2hdpr]
